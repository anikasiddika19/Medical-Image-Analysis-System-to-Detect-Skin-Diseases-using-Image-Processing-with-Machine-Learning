...
% Last Modified by GUIDE v2.5 28-Feb-2020 12:33:38
...
PSNR = psnr(noisy,uint8(ostu_img))
set(handles.edit2, 'String', PSNR)
 
%Global Contrast Factor
GCF = globalContrastFactor(ostu_img)
set(handles.edit3, 'String', GCF)
 
%Mean Square Error
MSE = immse(noisy,uint8(ostu_img))
set(handles.edit4, 'String', MSE)
 
%Structural Similarity Index
SSIM = ssim(noisy,uint8(ostu_img))
