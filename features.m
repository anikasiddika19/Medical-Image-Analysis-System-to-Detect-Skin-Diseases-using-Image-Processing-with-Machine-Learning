...
% Last Modified by GUIDE v2.5 30-Apr-2020 17:01:39
...
v=var(I)
set(handles.edit6, 'String', v)
k=kurtosis(I)
set(handles.edit7, 'String', k)
sk=skewness(I)
set(handles.edit8, 'String', sk)
%rms=sqrtm(I)
...
%core=gg(1,8)
set(handles.edit11, 'String', core)
%energy=gg(8,1)
set(handles.edit12, 'String', energy)
%homo=gg(8,8)
set(handles.edit13, 'String', homo)

RMS=mean2(rms(I))
set(handles.edit14, 'String', RMS)
...
IDM = in_diff
set(handles.edit16, 'String', smoothness)
