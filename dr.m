%%%watershed 
A = imread('C:\Users\User\Desktop\JK\dr0.jpg');
...
A2 = imread('C:\Users\User\Desktop\JK\dr1.jpg');
...
A2 = imread('C:\Users\User\Desktop\JK\dr3.jpg');
A2=imresize(A2, [300 300]);
I2=rgb2gray(A2);
mask2 = false(size(I2));
mask2(25:end-25,25:end-25) = true;
...
A2 = imread('C:\Users\User\Desktop\JK\dr2.jpg');
A2=imresize(A2, [300 300]);
I2=rgb2gray(A2);
mask2 = false(size(I2));
mask2(25:end-25,25:end-25) = true;
