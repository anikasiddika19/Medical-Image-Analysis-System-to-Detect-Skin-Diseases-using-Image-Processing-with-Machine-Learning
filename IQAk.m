function varargout = IQAk(varargin)
% IQAK MATLAB code for IQAk.fig
%      IQAK, by itself, creates a new IQAK or raises the existing
%      singleton*.
%
%      H = IQAK returns the handle to a new IQAK or the handle to
%      the existing singleton*.
%
%      IQAK('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IQAK.M with the given input arguments.
%
%      IQAK('Property','Value',...) creates a new IQAK or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before IQAk_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to IQAk_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help IQAk

% Last Modified by GUIDE v2.5 07-Mar-2020 11:56:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @IQAk_OpeningFcn, ...
                   'gui_OutputFcn',  @IQAk_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before IQAk is made visible.
function IQAk_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to IQAk (see VARARGIN)

% Choose default command line output for IQAk
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes IQAk wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = IQAk_OutputFcn(hObject, eventdata, handles) 
